...
### 1. Enterprise-Style Defensive Homelab

A segmented cybersecurity lab simulating enterprise infrastructure with pfSense, Active Directory, Windows clients, Linux servers, Wazuh, Security Onion, and centralized logging.
...
Documentation: [`/homelab`](./homelab)

---

### 2. DShield Honeypot and SIEM Monitoring

A honeypot monitoring project designed to observe real-world internet scanning and attack attempts while keeping honeypot traffic isolated from internal networks.

**Skills demonstrated:**

* Honeypot deployment
* SSH attack observation
* Elastic dashboard analysis
* Log parsing
...
### 3. Windows Event Forwarding and Active Directory Logging

A Windows logging project using domain-joined Windows systems and centralized event forwarding for monitoring authentication, administrative activity, and security-relevant Windows events.

**Skills demonstrated:**

* Windows Event Forwarding
* Group Policy configuration
* Domain-based log collection
* Windows security event analysis
* SIEM-ready log design

---

### 4. Network Security Monitoring with Security Onion

A network visibility project using Security Onion, Zeek, Suricata, and packet-based telemetry to analyze lab traffic and security events.
...
### 5. Python and Automation Practice

Python scripting practice developed through cybersecurity coursework, CTFs, and GPYC preparation.
